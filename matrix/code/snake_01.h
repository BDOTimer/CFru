...
namespace snake
{
  ...
  //using  vec2i_t   =   sf::Vector2i;
    ...
    {       Config() : pmap(&map_01)
        ...
        bool is_apple(int status){ return status == APPLE; }
    ...
    {       Cell() = default;
        ...
        void set(const int status)     { this->status = status     ; }
